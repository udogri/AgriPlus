...
const BuyerSignup = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    idDocument: null, bankName: '', accountNumber: '', accountName: '',
  });
      ...
      <VStack spacing="20px" align="start">
        {step === 1 && (
          <>
            ...
            <FormControl><FormLabel>Address</FormLabel><Textarea id="farmAddress" placeholder="Enter your farm/home address" value={formData.homeAddress} onChange={handleChange} /></FormControl>
          </>
        )}
        ...
        {step === 2 && (
          <>
            ...
            <FileUploadInput id="idDocument" label="NIN" file={formData.idDocument} handleChange={handleChange} />
